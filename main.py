...
# --- Song URI Finder Function --- #
def find_songs(song_list: list) -> list:
    passed = 0
    skipped = 0
    song_uris = []
...
def main():
    ...
    user_date = input("What date do you want to pull music from? (YYYY-MM-DD Format): ")
    # user_date = "2000-08-12" <-- for debugging
    ...
    uri_list = find_songs(song_names)
